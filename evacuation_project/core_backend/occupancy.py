...
occupancy_load_factors = {
    ...
    "gym":              (5.0,  "fitness suite - project default; equipment occupies the floor, so "
                               "it is not an assembly space"),
    "laundry":          (10.0, "communal laundry - project default; machine-occupied floor and "
                               "transient use"),
